...
<head>
  ...
  <title>Welcome to Weather Quixada</title>
<style>
...
<section class='container'>
          <hgroup>
            <h1>Welcome to your Python application on OpenShift - Weather</h1>
          </hgroup>

        <footer>
          <a href="https://github.com/KaynanCoelho/weather-rpc-server">https://github.com/KaynanCoelho/weather-rpc-server</a>
        </footer>
</section>
</body>
</html>'''
...
if __name__ == '__main__':
    ...
    httpd = make_server('127.7.143.129', 8051, application)
